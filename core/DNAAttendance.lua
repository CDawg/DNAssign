...
DNAAttendanceDeleteAllBtn = CreateFrame("Button", nil, DNAAttendanceScrollFrame, "UIPanelButtonTemplate")
...
local DNAAttendancelogCloseBtn = CreateFrame("Button", nil, DNAAttendanceExportWindow, "UIPanelButtonTemplate")
DNAAttendancelogCloseBtn:SetSize(100, 24)
DNAAttendancelogCloseBtn:SetPoint("TOPLEFT", 100, -DNAAttendanceExportWindowScrollFrame_h-52)
