...
local function UpdateMapButton()
  ...
  --end
  DN:Debug("MMI UpdateMapButton: " .. point .. "," .. xOfs .. "," .. yOfs)
...
local DNADialogMMIReset = CreateFrame("Frame", nil, UIParent, "BackdropTemplate")
...
local DNADialogMMIResetNo = CreateFrame("Button", nil, DNADialogMMIReset, "BackdropTemplate")
...
local DNADialogMMIResetYes = CreateFrame("Button", nil, DNADialogMMIReset, "BackdropTemplate")
...
local DNADialogWTFReset = CreateFrame("Frame", nil, UIParent, "BackdropTemplate")
...
local DNADialogWTFResetNo = CreateFrame("Button", nil, DNADialogWTFReset, "BackdropTemplate")
...
local DNADialogWTFResetYes = CreateFrame("Button", nil, DNADialogWTFReset, "BackdropTemplate")
...
local DNAWTFRestore = CreateFrame("Button", nil, page["Settings"], "BackdropTemplate")
